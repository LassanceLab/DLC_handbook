...
~/_SHARE_/Research/NEU/EVONEURO/SOCIAL-BEHAVIOR]$ rsync -av --chmod=ug=rwX --progress USERNAME@frontal.lucia.cenaero.be:/gpfs/projects/acad/behavior/videos/ ./ > tmp  
  
# sync  
rsync -av --progress --no-p --no-g --chmod=ug=rwX path/to/source/folder USERNAME@massstorage.giga.priv:/massstorage/URT/<Unit>/<Lab>/<Team>/<Project>/<Folder>  
```  
